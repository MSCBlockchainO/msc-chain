...
func TestHandleMetricsExposesCoreMetrics(t *testing.T) {
	...
	for _, name := range []string{
		...
		"msc_node_ready",
		"msc_node_runtime_pressure_mode",
		"msc_node_goroutine_count",
		"msc_node_goroutine_warn_threshold",
		"msc_node_gossip_quiet",
		"msc_node_live_validators",
		"msc_validator_pool_active",
		"msc_validator_pool_standby",
		"msc_validator_pool_performance_slots",
		"msc_validator_pool_rotation_slots",
		...
		"msc_consensus_fast_proposer_failover_enabled",
		"msc_consensus_effective_proposer_round_timeout_seconds",
