...
$nodes = @(
    @{ Id = "A";     Role = "validator"; Port = 7001; Rpc = "127.0.0.1:26657"; PasswordEnv = "MSC_NODE_PASSWORD_A" },
    @{ Id = "B";     Role = "validator"; Port = 7002; Rpc = "127.0.0.1:26658"; PasswordEnv = "MSC_NODE_PASSWORD_B" },
    @{ Id = "C";     Role = "validator"; Port = 7003; Rpc = "127.0.0.1:26659"; PasswordEnv = "MSC_NODE_PASSWORD_C" },
    @{ Id = "D";     Role = "validator"; Port = 7004; Rpc = "127.0.0.1:26660"; PasswordEnv = "MSC_NODE_PASSWORD_D" },
    @{ Id = "F";     Role = "full";      Port = 7005; Rpc = "127.0.0.1:26661"; PasswordEnv = "MSC_NODE_PASSWORD_F" },
    @{ Id = "G";     Role = "full";      Port = 7006; Rpc = "127.0.0.1:26662"; PasswordEnv = "MSC_NODE_PASSWORD_G" },
    @{ Id = "Talha"; Role = "full";      Port = 7007; Rpc = "127.0.0.1:26663"; PasswordEnv = "MSC_NODE_PASSWORD_TALHA" },
    @{ Id = "T";     Role = "full";      Port = 7008; Rpc = "127.0.0.1:26664"; PasswordEnv = "MSC_NODE_PASSWORD_T" },
    @{ Id = "W";     Role = "full";      Port = 7010; Rpc = "127.0.0.1:26665"; PasswordEnv = "MSC_NODE_PASSWORD_W" }
)
...
function Start-Node {
    ...
    $command = @(
        ...
        "go run . --mode=full --role=$($Node.Role) --id=$id --port=$($Node.Port) --datadir=$dataDir --rpcaddr $($Node.Rpc) *> '$($log.Replace("'","''"))'"
    ) -join "; "
